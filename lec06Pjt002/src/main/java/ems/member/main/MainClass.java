...
import ems.member.asesembler.StudentAssembler;
...
public class MainClass {
	public static void main(String[] args) {
		...
		for(int loop=0 ; loop<sNums.length; loop++) {
			Student student = new Student(sNums[loop], sIds[loop], sPws[loop], sNames[loop], sAges[loop], sGenders[loop], sMajors[loop]);
